// Generated on 2017-01-12 using generator-angular-fullstack 3.0.0
'use strict';
    ...
    clean: {
      ...
      dev: {
        files: [{
          ...
          src: [
            '.tmp',
            '<%= yeoman.dev %>/!(.git*|.openshift|Procfile)**'
          ]
        }]
      }
    },
    ...
    copy: {
      ...
      dev: {
        files: [{
          ...
          expand: true,
          cwd: '.tmp/images',
          dest: '<%= yeoman.dev %>/<%= yeoman.client %>/assets/images',
          src: ['generated/*']
        }, {
          expand: true,
          cwd: '.tmp/',
          dest: '<%= yeoman.dev %>/<%= yeoman.client %>/app',
          src: ['templates.js']
        }, {
          expand: true,
          cwd: '.tmp/',
